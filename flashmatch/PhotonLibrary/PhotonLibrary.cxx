...
namespace phot{
  ...
  void PhotonLibrary::LoadLibraryFromFile(std::string LibraryFile, size_t NVoxels)
  {
	...
	if(!f) {
	  ...
	  //std::cerr<<"/grid/fermiapp/products/uboone/uboone_data/v01_04_00/PhotonPropagation/LibraryData/uboone_photon_library_v6.root"<<std::endl;
	  std::cerr<<"/cvmfs/icarus.opensciencegrid.org/products/icarus/icarus_data/v08_28_00/icarus_data/PhotonLibrary/PhotonLibrary-20180801.root"<<std::endl;
	  throw std::exception();
	}
